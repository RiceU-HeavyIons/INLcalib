...
int main(int argc, char *argv[])
{
  ...
  for(int iboard=0;iboard<8;iboard++){
    ...
    sprintf(tmpchr,"../test/%s",tdigname[iboard].c_str());CreateDir(tmpchr);
    sprintf(tmpchr,"../test/%s/inl",tdigname[iboard].c_str());CreateDir(tmpchr);
    sprintf(tmpchr,"../test/%s/root",tdigname[iboard].c_str());CreateDir(tmpchr);
    sprintf(tmpchr,"../test/%s/gif",tdigname[iboard].c_str());CreateDir(tmpchr);
  }
  ...
  TH2F* checkdoublepeaka2h=new TH2F("checkdoublepeaka","checkdoublepeaka",1024,-0.5,1023.5,180,12730,12820);
  TH2F* checkdoublepeakb2h=new TH2F("checkdoublepeakb","checkdoublepeakb",1024,-0.5,1023.5,180,10200,10290);
  TH2F* checkdoublepeakc2h=new TH2F("checkdoublepeakc","checkdoublepeakc",1024,-0.5,1023.5,180,7620,7710);

  TH2F* checkdoublepeakd2h=new TH2F("checkdoublepeakd","checkdoublepeakd",4,-0.5,3.5,180,12730,12820);
  TH2F* checkdoublepeake2h=new TH2F("checkdoublepeake","checkdoublepeake",4,-0.5,3.5,180,10200,10290);
  TH2F* checkdoublepeakf2h=new TH2F("checkdoublepeakf","checkdoublepeakf",4,-0.5,3.5,180,7620,7710);

  TH2F* checkdoublepeakg2h=new TH2F("checkdoublepeakg","checkdoublepeakg",32,-0.5,31.5,180,12730,12820);
  TH2F* checkdoublepeakh2h=new TH2F("checkdoublepeakh","checkdoublepeakh",32,-0.5,31.5,180,10200,10290);
  TH2F* checkdoublepeaki2h=new TH2F("checkdoublepeaki","checkdoublepeaki",32,-0.5,31.5,180,7620,7710);


  sprintf(tmpchr,"../rawdata/%s.dat",filename);
  // sprintf(tmpchr,"../rawdata/sptests/%s.dat",filename);
  ...
  int goodevents=0;
  float time[8][3][totchan];
  int ntime[8][3][totchan];
  int lastevents=0;
  int wrongedge=0;
  int halftrayid=-1;
      ...
      for(int itdc=0;itdc<3;itdc++){
        for(int i=0;i<totchan;i++){
          for(int j=0;j<totchan;j++){
            ...
            int bin=ntime[iboard][itdc][i] & 0x000003ff;
            int rc=ntime[iboard][itdc][i] & 0x0000003;
            int ddl=ntime[iboard][itdc][i] & 0x00001f;
            if(iboard == 0 && itdc == 0 && i==6 && j==1) checkdoublepeaka2h->Fill(bin,deltatime);
            if(iboard == 0 && itdc == 0 && i==6 && j==2) checkdoublepeakb2h->Fill(bin,deltatime);
            if(iboard == 0 && itdc == 0 && i==6 && j==3) checkdoublepeakc2h->Fill(bin,deltatime);

            if(iboard == 0 && itdc == 0 && i==6 && j==1) checkdoublepeakd2h->Fill(rc,deltatime);
            if(iboard == 0 && itdc == 0 && i==6 && j==2) checkdoublepeake2h->Fill(rc,deltatime);
            if(iboard == 0 && itdc == 0 && i==6 && j==3) checkdoublepeakf2h->Fill(rc,deltatime);

            if(iboard == 0 && itdc == 0 && i==6 && j==1) checkdoublepeakg2h->Fill(ddl,deltatime);
            if(iboard == 0 && itdc == 0 && i==6 && j==2) checkdoublepeakh2h->Fill(ddl,deltatime);
            if(iboard == 0 && itdc == 0 && i==6 && j==3) checkdoublepeaki2h->Fill(ddl,deltatime);
          }
        }
      }
    }
  ...
  for(int iboard=0;iboard<8;iboard++){
    ...
    for(int itdc=0;itdc<3;itdc++){	 
      ...
      sprintf(tmpchr,"../test/%s/root/n%s.tdc%d.corr1.root",tdigname[iboard].c_str(),tdigname[iboard].c_str(),itdc);
      if(processmode=="8")sprintf(tmpchr,"../test/%s/root/n%s.tdc%d.corr8.root",tdigname[iboard].c_str(),tdigname[iboard].c_str(),itdc);
      ...
      checkdoublepeaka2h->Write();
      checkdoublepeakb2h->Write();
      checkdoublepeakc2h->Write();
      checkdoublepeakd2h->Write();
      checkdoublepeake2h->Write();
      checkdoublepeakf2h->Write();
      checkdoublepeakg2h->Write();
      checkdoublepeakh2h->Write();
      checkdoublepeaki2h->Write();
    ...
    for(int itdc=0;itdc<3;itdc++){
      ...
      for(int i=0;i<8;i++){
        for(int j=0;j<8;j++){
          ...
          ipage=ifig/4;
          if(lastpage !=ipage) {
            sprintf(tmpchr,"../test/%s/gif/%s-tdc%d-page%d-deltatime.gif",tdigname[iboard].c_str(),tdigname[iboard].c_str(),itdc,ipage);
            c1->Print(tmpchr);
            lastpage=ipage;
          }
        }
