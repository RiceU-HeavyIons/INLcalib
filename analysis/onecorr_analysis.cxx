...
int main(int argc, char *argv[])
{
  ...
  for(int iboard=0;iboard<8;iboard++){
    ...
    for(int itdc=0;itdc<3;itdc++){
      for(int ich=0;ich<8;ich++){
        ...
        sprintf(tmpchr,"./tempana//%s/inl/%s.tdc%d.inl",tdigname[iboard].c_str(),tdigname[iboard].c_str(),itdc);
        if(processmode=="8")sprintf(tmpchr,"./tempana//%s/inl/%s.tdc%d.ch%d.inl",tdigname[iboard].c_str(),tdigname[iboard].c_str(),itdc,ich);
  ...
  TH2F* checkdoublepeaka2h=new TH2F("checkdoublepeaka","checkdoublepeaka",1024,-0.5,1023.5,180,10200,10290);
  TH2F* checkdoublepeakb2h=new TH2F("checkdoublepeakb","checkdoublepeakb",1024,-0.5,1023.5,180,7620,7710);
  TH2F* checkdoublepeakc2h=new TH2F("checkdoublepeakc","checkdoublepeakc",1024,-0.5,1023.5,180,5060,5150);

  TH2F* checkdoublepeakd2h=new TH2F("checkdoublepeakd","checkdoublepeakd",4,-0.5,3.5,180,10200,10290);
  TH2F* checkdoublepeake2h=new TH2F("checkdoublepeake","checkdoublepeake",4,-0.5,3.5,180,7620,7710);
  TH2F* checkdoublepeakf2h=new TH2F("checkdoublepeakf","checkdoublepeakf",4,-0.5,3.5,180,5060,5150);

  TH2F* checkdoublepeakg2h=new TH2F("checkdoublepeakg","checkdoublepeakg",32,-0.5,31.5,180,10200,10290);
  TH2F* checkdoublepeakh2h=new TH2F("checkdoublepeakh","checkdoublepeakh",32,-0.5,31.5,180,7620,7710);
  TH2F* checkdoublepeaki2h=new TH2F("checkdoublepeaki","checkdoublepeaki",32,-0.5,31.5,180,5060,5150);
      ...
      for(int itdc=0;itdc<3;itdc++){
        for(int i=0;i<totchan;i++){
          for(int j=0;j<totchan;j++){
            ...
            int bin=int(ntime[iboard][itdc][i]) & 0x000003ff;
            int rc=int(ntime[iboard][itdc][i]) & 0x0000003;
            int ddl=int(ntime[iboard][itdc][i]) & 0x00001f;
            if(iboard == 0 && itdc == 1 && i==5 && j==1) checkdoublepeaka2h->Fill(bin,deltatime);
            if(iboard == 0 && itdc == 1 && i==5 && j==2) checkdoublepeakb2h->Fill(bin,deltatime);
            if(iboard == 0 && itdc == 1 && i==5 && j==3) checkdoublepeakc2h->Fill(bin,deltatime);

            if(iboard == 0 && itdc == 1 && i==5 && j==1) checkdoublepeakd2h->Fill(rc,deltatime);
            if(iboard == 0 && itdc == 1 && i==5 && j==2) checkdoublepeake2h->Fill(rc,deltatime);
            if(iboard == 0 && itdc == 1 && i==5 && j==3) checkdoublepeakf2h->Fill(rc,deltatime);

            if(iboard == 0 && itdc == 1 && i==5 && j==1) checkdoublepeakg2h->Fill(ddl,deltatime);
            if(iboard == 0 && itdc == 1 && i==5 && j==2) checkdoublepeakh2h->Fill(ddl,deltatime);
            if(iboard == 0 && itdc == 1 && i==5 && j==3) checkdoublepeaki2h->Fill(ddl,deltatime);
  ...
  for(int iboard=0;iboard<8;iboard++){
    ...
    for(int itdc=0;itdc<3;itdc++){	 
      ...
      sprintf(tmpchr,"./tempana//%s/root/%s.tdc%d.corr1.root",tdigname[iboard].c_str(),tdigname[iboard].c_str(),itdc);
      if(processmode=="8")sprintf(tmpchr,"./tempana//%s/root/%s.tdc%d.corr8.root",tdigname[iboard].c_str(),tdigname[iboard].c_str(),itdc);
    ...
    for(int itdc=0;itdc<3;itdc++){
      ...
      for(int i=0;i<8;i++){
        for(int j=0;j<8;j++){
          ...
          ipage=ifig/4;
          if(lastpage !=ipage) {
            sprintf(tmpchr,"./tempana//%s/gif/%s-tdc%d-page%d-deltatime.gif",tdigname[iboard].c_str(),tdigname[iboard].c_str(),itdc,ipage);
            c1->Print(tmpchr);
            lastpage=ipage;
          }
        }
